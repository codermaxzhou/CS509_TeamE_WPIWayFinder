// from http://stackoverflow.com/questions/14186955/create-a-autocompleting-textbox-in-java-with-a-dropdown-list
package mapview;
...
class AutoSuggestor implements FocusListener {
    ...
    public void focusGained(FocusEvent e) {
        if(textField.getSelectionEnd() != textField.getSelectionStart()) {

...
public class RightSideBar extends JPanel implements MouseListener, ActionListener, ListSelectionListener{
    ...
    private void classroomLabelMouseClicked(java.awt.event.MouseEvent evt) {                                            
        // TODO add your handling code here:
    ...
    private void restroomLabelMouseClicked(java.awt.event.MouseEvent evt) {                                           
        // TODO add your handling code here:
...
//        secRightSideBar.setBackground(Color.white);
    ...
    private void classroomLabelMouseEntered(java.awt.event.MouseEvent evt) {                                            
        // TODO add your handling code here:
    ...
    private void classroomLabelMouseExited(java.awt.event.MouseEvent evt) {                                           
        // TODO add your handling code here:
         this.classroomLabel.setBounds(this.classroomLabel.getX() + 5, this.classroomLabel.getY() + 10,
           this.classroomLabel.getHeight() , this.classroomLabel.getWidth() );
        this.repaint();
    ...
    private void restroomLabelMouseEntered(java.awt.event.MouseEvent evt) {                                           
        // TODO add your handling code here:
    ...
    private void restroomLabelMouseExited(java.awt.event.MouseEvent evt) {                                          
        // TODO add your handling code here:
        this.restroomLabel.setBounds(this.restroomLabel.getX() + 5, this.restroomLabel.getY() + 5,
           this.restroomLabel.getHeight() , this.restroomLabel.getWidth() );
        this.repaint();
    ...
    private void goCampusButtonMouseClicked(java.awt.event.MouseEvent evt) {                                            
        try {
            // TODO add your handling code here:
